...
> 최종 데이터는 13절 기준입니다. X2는 RS-019(중국 희토류 자석 선적별 수출 허가, 60일)로, X1-A는 RS-001(EU 역외 설치·시운전 기술자 취업 허가 확인)로 바뀌었고 X2 수치는 2028-02-11(+52일)·행동 기한 2027-02-08입니다. 아래 7.1~7.2의 30일·2028-01-11·2027-03-10은 보완판 시점의 값입니다.
...
L2 실제 기사 19건에서 이미 확인한 두 건에 맞췄습니다. 추가 조사, 새 기사, X1-B 변경은 하지 않았습니다. 일정·날짜·공지 문구는 합성이며 기사 속 지연 기간은 계산에 쓰지 않습니다. 판단 기록에는 근거 기사의 제목·출처·발행일·링크가 표시되고, 이 정보는 모델 입력에 넣지 않습니다.

| 시나리오 | 근거 실제 사례 | 원인 | 지연 방식 | 영향받는 품목·작업 유형 |
| --- | --- | --- | --- | --- |
| X2 | RS-019 · CNBC · 2025-10-15 · 중국 희토류 수출 통제로 선적마다 허가 필요, 수 주~2~3개월 대기 | 중국산 희토류 영구자석과 이를 포함한 부품의 선적별 수출 허가(합성 공지: 최대 60일) | 허가 없이는 통관 불가. 통보 품목(P-A1)이 1주 늦고, 같은 허가가 필요한 이후 선적도 각각 대기 | 서보 모터·자석을 포함한 구매 품목: P-B 교육 시뮬레이터 구동부(T058), P-C 교정용 정밀 서보 스테이지(T051) |
| X1-A | RS-001 · CNN · 2025-09-11 · 현대·LG 배터리 공장 단속으로 설비 설치·검증 기술자가 빠져 가동 2~3개월 지연 | EU 역외 기술자의 취업 허가 확인(합성 공지: 2026-11-01부터, 최대 30일) | 확인 전에는 현장 설치·시운전 작업 착수 불가 | 역외(한국) 협력사 Vendor A의 현장 작업 T046·T048·T051·T053. 독일(EU) Vendor B 작업은 비해당 |

계산기로 확인한 값: X2 규칙만 2027-12-21(변화 0일). P-B는 T058 여유 245일로 60일 흡수. P-C는 T051 여유 0일이라 허가가 늦으면 2028-02-11(+52일), 행동 기한 2027-02-08. X1-A 최악 조건(T046 착수 30일 보류)은 2028-02-01, 행동 기한 2026-11-05.

실제 모델 녹화(최종, `data/llm_replay/hero_demo.json` 22건):
- X2: 원인 연결 → P-B·P-C 발견 → 여유 → P-C 조건부 계산 → 대응안 비교 거절 → M4. 질문 "P-C가 선적별 중국 희토류 수출 허가 대상이며 관련 허가 서류가 실제로 필요한지 확인해 주시겠습니까? (서류 제출 기한: P-C 2027-02-08)". 기한은 모델이 빠뜨려 계산 결과로 붙임.
- X1-A: 후보 추리기 → 작업 속성 → L2 검색(결과 0건) → M4. 모델은 "Equipment Vendor A가 T046과 T053 수행을 위해 비EU 기술자를 헝가리 현장에 투입할 예정입니까?"라고 묻고 조건부 계산 전에 멈췄습니다. 작업 속성에는 협력사 소재국만 있고 기술자 국적은 없어서 적용 여부부터 확인한 것으로, 정답 파일의 기대 경로(여유·조건부 계산·기한 2026-11-05)와 다릅니다.
- X1-B: 작업 속성 → 여유(T013 168일) → M2. X2-대조: 사유가 달라 M1.
