...
| # | 누를 곳 | 정상 화면 |
| --- | --- | --- |
| 1–2 | **변경** → 합성 통보 목록 맨 위 '대표 데모'의 `X2 · 대표 데모 · 협력사 통보에 없던 숨은 위험 찾기` → **합성 통보 불러오기** | 카드 2장: 같은 시기 외부 공지 N-X2(자동으로 함께 불러옴)와 X2 통보. X2 카드에 해석된 변경 **T042 · 완료 예정일 2026-03-14**, 아래 '같은 시기 외부 공지 1건이 같은 작업(T042)에 걸려 있습니다' |
